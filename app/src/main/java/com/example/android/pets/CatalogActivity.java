...
public class CatalogActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView = (ListView) findViewById(R.id.text_view_pet);
    ...
    private void deleteAllPets(){
        ...
        if(rowsDeleted > 0){
        Toast.makeText(CatalogActivity.this, R.string.editor_delete_pets_successful, Toast.LENGTH_SHORT).show();

        }else{
            Toast.makeText(CatalogActivity.this, R.string.editor_delete_pets_failed, Toast.LENGTH_SHORT).show();
        }
    }
